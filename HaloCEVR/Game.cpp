...
void Game::SetupConfigs()
{
	...
	c_SwapHandDistance = config.RegisterFloat("SwapHandDistance", "Maximum distance between both hands where the off hand grip action will enable two handed aiming (<0 for any distance)", 0.3f);
