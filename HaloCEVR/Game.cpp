...
void Game::SetupConfigs()
{
	...
	c_LeftHandShoulderHolsterDistance = config.RegisterFloat("LeftHandShoulderHolster", "Experimental - Bringing the left hand within this distance of a shoulder will swap weapons (<0 to disable)", 0.3f);
	c_RightHandShoulderHolsterDistance = config.RegisterFloat("RightHandShoulderHolster", "Experimental - Bringing the right hand within this distance of a shoulder will swap weapons (<0 to disable)", 0.3f);
