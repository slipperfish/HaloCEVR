...
public:
	...
	INDIRECT(CutsceneData,        0x07f8b0, 0x32, "0f bf 44 24 04 8b 04 85 ?? ?? ?? ?? 8b 4c 24 0c 56 8b 74 24 0c 51 8d 50 1c 0f bf 40 1a 52 50 56");
	INDIRECT(CampaignLoading,     0x0c7886, 0x02, "38 1d ?? ?? ?? ?? 74 ?? e8 ?? ?? ?? ?? 38 1d ?? ?? ?? ?? 74 ?? e8 ?? ?? ?? ?? bf 1e 00 00 00 89 3d");
