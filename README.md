...
By default, you can switch weapons using a controller binding. Alternatively, if enabled in the config.txt file, you can switch weapons using shoulder weapon holsters. With this setting enabled, first hover your main hand over a shoulder, then press the switch weapon binding to change weapons.
